...
const en: MainTranslations = {
  ...
  trayTooltipLine2: (sessionResets, weeklyResets) => `Sess: ${sessionResets} | Wkly: ${weeklyResets}`,
  trayTooltipLine3: (sessionAt, weeklyAt) => `Sess at: ${sessionAt} | 7d at: ${weeklyAt}`,
  trayTooltipNextUpdate: (t) => `Next poll: ${t}`,
...
const ptBR: MainTranslations = {
  ...
  trayTooltipLine2: (sessionResets, weeklyResets) => `Sess: ${sessionResets} | Sem.: ${weeklyResets}`,
  trayTooltipLine3: (sessionAt, weeklyAt) => `Sess às: ${sessionAt} | 7d às: ${weeklyAt}`,
  trayTooltipNextUpdate: (t) => `Próxima: ${t}`,
