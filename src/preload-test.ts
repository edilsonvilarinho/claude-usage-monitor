...
contextBridge.exposeInMainWorld('claudeUsage', {
  ...
  getCliSessions: () => Promise.resolve(mockData.cliSessions ?? []),
  getCliSessionTurns: (_sessionId: string) => Promise.resolve(mockData.cliSessionTurns ?? []),
  deleteAllCliSessions: () => Promise.resolve(true),
  deleteCliSession: (_sessionId: string) => Promise.resolve(true),
